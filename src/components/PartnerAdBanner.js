  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2.5 sm:gap-3.5 min-w-0 z-10 flex-1 mr-2">
        ...
        <div className="flex items-center justify-center shrink-0 w-7 h-7 sm:w-8 sm:h-8 md:w-10 md:h-10 app-ad-logo rounded-lg sm:rounded-xl bg-white/10 p-0.5 sm:p-1 border border-white/10 shadow-sm overflow-hidden">
          <img
        ...
        <div className="flex flex-col min-w-0 justify-center leading-tight">
          <div className="flex items-center gap-1.5 sm:gap-2">
            <span className="text-[11.5px] sm:text-sm md:text-base app-ad-title font-bold text-white tracking-tight flex items-center gap-1 truncate">
              Interactive Brokers
          ...
          <span className="text-[10px] sm:text-xs md:text-sm app-ad-sub font-medium text-slate-300/95 truncate">
      ...
      <div className="flex items-center shrink-0 z-10">
        <div className="inline-flex items-center gap-1 sm:gap-1.5 px-2.5 sm:px-3.5 md:px-4 py-1 sm:py-1.5 md:py-2 rounded-lg sm:rounded-xl bg-gradient-to-r from-amber-500 to-amber-600 text-slate-950 font-black text-[10.5px] sm:text-xs md:text-sm app-ad-btn shadow-sm group-hover:brightness-110 transition-all">
          <span>Claim</span>
